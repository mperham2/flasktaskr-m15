...
class AllTests(unittest.TestCase):
    ...
    def test_duplicate_user_registration_throws_error(self):
        ...
        self.assertIn(
                'That username and/or email already exist.',
                response.data
                )

    def test_user_registration_field_error_required_field_username(self):
        response = self.register('', 'michael@realpython.com', 'python', 'python')
        self.assertIn('This field is required.', response.data)

    def test_user_registration_field_error_required_field(self):
